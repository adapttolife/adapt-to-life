-- Givebutter donor journey ledger. Apply with:
--   cfrun npx wrangler d1 execute atl-waivers --remote --file schema/donor_gifts.sql
--
-- Givebutter remains the money system of record. This table owns only ATL's
-- communication state and the consent signal Givebutter supplied.
