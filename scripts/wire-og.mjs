...
const ALT = {
  ...
  "send-6": "Send 6 to the US Open. An adaptive water-skier on the tow rope, mid-run.",
  ...
  "ways-to-give": "Every road here ends on a court. An adaptive water-skier carving through the spray.",
};
